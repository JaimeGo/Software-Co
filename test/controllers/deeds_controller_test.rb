...
class DeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deed" do
    assert_difference('Deed.count') do
      post deeds_url, params: { deed: { expiration_date: @deed.expiration_date, state: @deed.state, user_id: @deed.user_id } }
    end
  ...
  test "should update deed" do
    patch deed_url(@deed), params: { deed: { expiration_date: @deed.expiration_date, state: @deed.state, user_id: @deed.user_id } }
